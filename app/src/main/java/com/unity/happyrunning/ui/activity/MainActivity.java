...
import com.unity.happyrunning.ui.adapter.MyFragmentPagerAdapter;
...
public class MainActivity extends AppCompatActivity implements RadioGroup.OnCheckedChangeListener, ViewPager.OnPageChangeListener {
    ...
    public void bindViews() {
        rb_walk = findViewById(R.id.walk_tab);
        rb_home = findViewById(R.id.home_tab);
        rb_running = findViewById(R.id.run_tab);
        rb_settings = findViewById(R.id.settings_tab);
