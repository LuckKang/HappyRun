...
import com.unity.happyrunning.commons.utils.CountTimerUtil;
import com.unity.happyrunning.commons.utils.DateUtils;
import com.unity.happyrunning.commons.utils.LogUtils;
import com.unity.happyrunning.commons.utils.Status_sp;
import com.unity.happyrunning.commons.utils.UIhelper;
...
import com.unity.happyrunning.sport_motion.MotionUtils;
import com.unity.happyrunning.sport_motion.PathSmoothTool;
...
//                apperaAnim2.start_bg();
                ...
                if (record == null)
                    record = new PathRecord();
                record.setmStartTime(mStartTime);
...
//                apperaAnim2.start_bg();
                ...
                //保存数据
                if (null != record && null != record.getmPathLinePoints() && !record.getmPathLinePoints().isEmpty()) {
                    saveRecord();
                } else {
    ...
    private void saveRecord() {
        ...
        try {
            ...
            List<LatLng> locations = record.getmPathLinePoints();
            ...
            sportMotionRecord.setMaster(Integer.parseInt(SPUtils.getInstance().getString(Status_sp.USERID, "0")));
            ...
            sportMotionRecord.setDistribution(record.getmDistribution());
...
//        }
        ...
        mSportLatLngs.clear();
        //轨迹平滑优化
        mSportLatLngs = new ArrayList<>(mpathSmoothTool.pathOptimize(record.getmPathLinePoints()));
        //抽稀
