...
import com.unity.happyrunning.sport_motion.TraceRePlay;
...
public class SportRecordDetailsMapFragment extends BaseFragment {
    ...
    public void initData(Bundle savedInstanceState) {
        ...
        mCalendar.setTimeInMillis(pathRecord.getmStartTime());
    ...
    private void setUpMap() {
        ...
        myLocationStyle.myLocationIcon(BitmapDescriptorFactory
                .fromResource(R.mipmap.mylocation_point));// 设置小蓝点的图标
