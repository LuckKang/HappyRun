package com.unity.happyrunning.ui.weight;
...
/**
 * 描述: 重写 LinearLayoutManager 为了ScrollView可以显示RecyclerView 垂直布局
*/
public class FullyLinearLayoutManager extends LinearLayoutManager {
    ...
    private void logMeasureWarning(int child) {
        LogUtils.w("LinearLayoutManager", "Can't measure child #" + child + ", previously used dimensions will be reused." +
    ...
    public void onLayoutChildren(RecyclerView.Recycler recycler, RecyclerView.State state) {
        //解决刷新IndexOutOfBoundsException问题
        try {
