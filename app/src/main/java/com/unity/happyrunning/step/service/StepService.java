package com.unity.happyrunning.step.service;
...
import com.unity.happyrunning.step.UpdateUiCallBack;
import com.unity.happyrunning.step.accelerometer.StepCount;
import com.unity.happyrunning.step.accelerometer.StepValuePassListener;
...
public class StepService extends Service implements SensorEventListener {
    ...
    private void initNotification() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            channel = new NotificationChannel("channel_1","n_run",NotificationManager.IMPORTANCE_LOW);
            channel.enableVibration(true);
            mNotificationManager.createNotificationChannel(channel);
        }

        mBuilder = new NotificationCompat.Builder(this,"channel_1");
...
//                    Logger.d("重置步数" + StepDcretor.CURRENT_STEP);
    ...
    private void remindNotify() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            channel = new NotificationChannel("channel_2","r_n_run",NotificationManager.IMPORTANCE_DEFAULT);
            channel.enableVibration(true);
            mNotificationManager.createNotificationChannel(channel);
        }
        NotificationCompat.Builder mBuilder = new NotificationCompat.Builder(this,"channel_2");
